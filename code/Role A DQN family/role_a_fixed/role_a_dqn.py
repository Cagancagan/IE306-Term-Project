...
Usage examples from repo root:
  python -m code.role_a_fixed.role_a_dqn train --algo double --seed 42 --episodes 300
  python -m code.role_a_fixed.role_a_dqn eval --algo double --weights weights/role_a_double_seed42.pt --seeds 0,1,2
"""
...
def train(args) -> None:
    ...
    log_path = f"logs/role_a_{args.algo}_seed{args.seed}.csv"
    weight_path = args.out or f"weights/role_a_{args.algo}_seed{args.seed}.pt"
    best_cost = float("inf")
    rows = []
