...
import csv
import numpy as np
# Yeni dosyadan DoubleDQNAgent'i çağırıyoruz
...
# 4. Kayıt İşlemleri (Dosya isimleri double_dqn olarak güncellendi)
torch.save(agent.q_net.state_dict(), "../../weights/double_dqn.pt")

with open("../../logs/double_dqn_seed42.csv", "w", newline="") as f:
    writer = csv.writer(f)
